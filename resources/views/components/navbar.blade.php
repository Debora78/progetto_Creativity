        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <form action="{{route('logout')}}"metode="POST" id="form-logout" class="d-none">
                @csrf
              </form>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link drop-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Benvenuto Ospite</a>
            <ul class="dropdown-menu">
